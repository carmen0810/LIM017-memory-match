...
function buildCards() {
  ...
  resultCards.forEach((value) => {
    HTML_Cards +=
      '<div class="card">' +
      '<div class="face hide" id="face_' + value.card_id + "-" + value.card_index + '" pokemon-back-id="back_' + value.card_id + "-" + value.card_index + '" style="border: ' + value.card_bgColor + ' solid 3px;background-color: white"><img src="' + value.card_image + '"  alt="'+ value.card_id +'" class="image-card image-card-mobile"/></div>' +
